          ...
          return (
            <React.Fragment key={index}>
              {data.skins.map((skin, skinindex) => {
                if(searchval!= "" && ((skin.displayName).toLowerCase()).indexOf((searchval).toLowerCase())==-1)return;
                ...
                return (
                  <div
                    key={skinindex}
                    className="col-lg-4 col-md-6 col-sm-12 skincontainer" style={{zIndex:"0"}}>
                    <div className="skins hovereffect">
                      ...
                      <div class="overlay" style={{ zIndex: "1" }}>
                        <Link
                          to={`/skin/${data.displayName.toLowerCase()}/${
                            skin.uuid
                          }`}
                          className="info"
                          onClick={() => {
